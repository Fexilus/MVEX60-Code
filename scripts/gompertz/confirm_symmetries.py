...
X_aut3 = Generator(t, W * ln(W / A) * ln(ln(W / A)))
X_aut4 = Generator(0, exp(-kG * t) * W)
X_aut5 = Generator(exp(-kG * t), -kG * exp(-kG * t) * W * ln(W / A))

autonomous_generators = [X_aut1, X_aut2, X_aut3, X_aut4, X_aut5]
